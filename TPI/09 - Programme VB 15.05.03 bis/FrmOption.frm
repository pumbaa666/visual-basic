...
Private Sub CmdOk_Click()
    ...
    ElseIf Int(TxtNbDes.Text) > 3 Then
...
Private Sub TxtTemps_LostFocus()
    If Int(TxtTemps.Text) = 1 Then LblSec.Caption = "seconde" Else LblSec.Caption = "secondes"
End Sub
