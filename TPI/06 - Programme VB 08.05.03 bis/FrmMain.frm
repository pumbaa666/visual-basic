...
Dim tAll(1, 23) As Integer ' 4 dés * 6 points : 24... -1 = 23
...
Dim vFichier As String
    ...
    For tCount(0) = 54 To FileLen(vFichier)
        If ((tCount(0) - 54) - 2) Mod (vLong * 3) = 0 Then  ' Si on passe à la ligne suivante
...
'                        EcrireImage tCount(0), 111
                        ...
                        vLastMeme = 0
                    ElseIf tPixNoir(1) = tPixNoir(0) And tPixNoir(1) > vLastMeme + 1 Then   ' Sinon, si il est sur la même ligne et qu'il n'a pas encore été compté...
...
Dim tPointsParDes(8) As Integer ' 9 dés maxi ==> 0 à 8
