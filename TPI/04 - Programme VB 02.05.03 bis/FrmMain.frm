...
Dim tCouleur(3), vChaineTot, vFichier As String
Dim vHaut, vLastMeme, vLigneEnCours As Integer
Dim vTemp As Byte
Dim vLast As Boolean    ' False = 0 = Blanc      True = 1 = Noir
   ...
   ' vFichier = "c:\blanc.bmp"
    ...
    For tCount(0) = 54 To FileLen(vFichier)
        If ((tCount(0) - 54) - 2) Mod (vLong * 3) = 0 Then
        ...
        If tCount(1) = 4 Then   ' Quand un pixel (4 octets) est lu
            If tCouleur(0) < 100 And tCouleur(1) < 100 And tCouleur(2) < 100 Then 'Si il y a un pixel noir
